...
- **Config store (DB)** + **Admin settings UI** — template HTML, watermark/signature/seal/letterhead images, ข้อความ §6 + 1x/2x, รูปแบบเลข — แก้ได้โดยไม่ deploy (FR-33/NFR-09, D-58/D-59)
