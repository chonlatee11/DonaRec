...
- **D-38 [deferred]:** Phase 3 receipts จะ **อ้างอิง/FK ถึง ledger** (allocation แยกอิสระจาก entity บริจาค) — **ไม่** ผูก Phase 2 กับ entity design ของ Phase 3 ล่วงหน้า (ปฏิเสธทางเลือก "minimal receipts table + ALTER")
