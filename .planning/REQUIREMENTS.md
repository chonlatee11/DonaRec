...
- [ ] **FR-15**: เลขที่ใบเสร็จ = ปีงบประมาณ + เลขรัน (เช่น 2569/000123) ตั้งค่ารูปแบบ/ตัวคั่น/จำนวนหลักได้ [M]
- [ ] **FR-16**: เลขไม่ซ้ำ เรียงต่อเนื่อง ห้ามข้ามเลข (gap-less) ภายในปีงบประมาณเดียวกัน [M]
- [ ] **FR-17**: รีเซ็ตเลขรันเป็น 1 อัตโนมัติเมื่อขึ้นปีงบประมาณใหม่ (1 ต.ค.) [M]
- [ ] **FR-18**: กำหนดปีงบประมาณจากวันที่ออกใบเสร็จ (วันอนุมัติ) อัตโนมัติ — ต.ค.–ธ.ค. นับเป็นปีงบประมาณถัดไป [M]
- [ ] **NFR-04**: เลขที่ใบเสร็จต้องไม่ซ้ำเด็ดขาดแม้มีผู้ใช้พร้อมกันหลายคน (concurrency-safe) [M]
...
- [ ] **FR-12**: ผู้อนุมัติ (Checker) อนุมัติหรือตีกลับรายการได้ พร้อมระบุเหตุผลตอนตีกลับ [M]
- [ ] **FR-14**: ใบเสร็จถูกสร้างก็ต่อเมื่อรายการได้รับการอนุมัติเท่านั้น (ไม่มี auto-issue; ผู้สร้างอนุมัติตัวเองไม่ได้) [M]
- [ ] **FR-19**: ยกเลิกใบเสร็จใช้สถานะ "ยกเลิก" ไม่ลบเลขทิ้ง (เก็บร่องรอยเพื่อตรวจสอบบัญชี/ภาษี) [M]
...
- [ ] **FR-29**: จัดเก็บข้อมูลผู้บริจาค: ชื่อ, เลขผู้เสียภาษี/บัตรประชาชน, ที่อยู่, อีเมล [M]
