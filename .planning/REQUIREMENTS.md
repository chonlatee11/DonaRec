...
- [x] **FR-08**: แสดงคิวรายการ "รอตรวจสอบ" จากเว็บ (Flow B) [M]
...
- [x] **FR-27**: บันทึกสถานะการส่ง (สำเร็จ/ล้มเหลว) และส่งซ้ำได้กรณีล้มเหลว [M]
- [x] **FR-28**: เจ้าหน้าที่ดาวน์โหลดไฟล์ PDF เองได้ กรณีผู้บริจาคไม่มีอีเมล [S]
